    ...
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <section className="mt-8">
        ...
        <ul className="mt-4 space-y-3">
          {sources.map((source) => (
            <li key={source.name}>
              {/* The whole card is the link target, not just the title, so the
      ...
      <section className="mt-8">
        ...
        {/* Chunk the license text into a bordered panel with dividers so it
            reads as distinct points instead of one wall of grey. */}
        <div className="mt-3 divide-y divide-slate-200 rounded-lg border border-slate-200 bg-slate-50">
          ...
          <p className="p-4 leading-relaxed text-slate-600 sm:p-5">
            ...
            under their original copyright. No ownership of, or license over, those images is claimed
            here.
          </p>
          <p className="p-4 leading-relaxed text-slate-600 sm:p-5">
